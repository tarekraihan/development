...
<html class="no-js" lang="en">
  <head>
	...
	<link rel="stylesheet" href="<?php echo base_url();?>resource/css/style_timeline.css">
	<link rel="stylesheet" href="http://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.3.0/css/font-awesome.min.css">
	
	<link rel="stylesheet" href="<?php echo base_url();?>resource/css/jquery.mCustomScrollbar.css" />
	...
	<script src="<?php echo base_url();?>resource/js/timeline.js"></script>

    <script src="<?php echo base_url();?>resource/js/jquery.mCustomScrollbar.concat.min.js"></script>
	...
	<div class="row">
			...
			<div class="fixed contain-to-grid">
				<nav class="top-bar" data-topbar role="navigation" data-options="is_hover: true">
					<ul class="title-area">
						<li class="sitelogo">
							<a href="index.php"><img src="<?php echo base_url();?>resource/images/Logo.png"/></a>
						</li>  
